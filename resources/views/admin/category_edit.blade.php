	...
	<form action="" method="post" class="form form-horizontal" id="form-category-edit">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="{{$category->name}}" placeholder="" id="user-name" name="name" datatype="*" nullmsg="名称不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="number" class="input-text" value="{{$category->category_no}}" placeholder="" id="user-tel" name="category_no"  datatype="*" nullmsg="序号不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
