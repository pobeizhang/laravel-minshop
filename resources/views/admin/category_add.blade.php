	...
	<form action="" method="post" class="form form-horizontal" id="form-category-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="user-name" name="name" datatype="*" nullmsg="名称不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="number" class="input-text" value="0" placeholder="" id="user-tel" name="category_no"  datatype="*" nullmsg="序号不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
